 ...
 * quantidade de votos válidos para cada candidato, além de efetuar também a leitura da quantidade de votos
 *  nulos e votos em branco. Ao final o programa deve apresentar o número total de eleitores, considerando 
 *  votos válidos, nulos e em branco; o percentual correspondente de votos válidos em relação à quantidade de eleitores;
 ...
 *   o percentual correspondente de votos nulos em relação à 
 * quantidade de eleitores; e por último o percentual correspondente de votos em branco em relação à quantidade de eleitores.
 * 
 * 
 * @author Gabriel
 *
